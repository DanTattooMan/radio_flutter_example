...
class BlackDragon extends StatefulWidget {
  @override
  _BlackDragonState createState() => _BlackDragonState();
}

class _BlackDragonState extends State<BlackDragon>
...
class FavoritImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        child: Image.asset(
    'assets/images/tattoo_black.png'
